      ...
      <div className="container">
        <div className="page-header">
          ...
          <p className="page-subtitle">
            Discover ASP Global Marine Trading LLC - Your trusted partner in marine solutions
          </p>
        </div>
        ...
        <section className="about-intro">
          <div className="intro-content">
            <p>
              Welcome to ASP Global Marine Trading LLC, a leading supplier of marine and offshore equipment 
              since 2005. As part of Ocean Serenity Group, we have established ourselves as a trusted 
              partner for shipowners, operators, and offshore companies worldwide.
            </p>
            <p>
              Explore our comprehensive sections to learn more about our company, certifications, 
              quality standards, clients, mission, and management message.
            </p>
          </div>
        </section>
        ...
        <section className="about-cta">
          <div className="cta-content">
            ...
            <p>
              Discover how ASP Global Marine Trading LLC can support your maritime operations with 
