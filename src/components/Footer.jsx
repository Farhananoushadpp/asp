      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-block">
            ...
            <p className="footer-tagline">Driven by Quality. Propelled by Trust.</p>
          </div>
          ...
          <div className="footer-block">
            ...
            <ul className="footer-links">
              <li><a href="#products">Engine Spares</a></li>
              <li><a href="#products">Pumps & Systems</a></li>
              <li><a href="#products">Safety Equipment</a></li>
              <li><a href="#products">Deck Stores</a></li>
            </ul>
          </div>
          ...
          <div className="footer-block">
            ...
            <div className="footer-contact">
              <p>Xavier Business Center<br />Office Suite A5-18<br />Dubai, UAE</p>
              <p>+971 4 572 4542</p>
        ...
        <div className="footer-bottom">
          <p className="copyright">
            Copyright {currentYear} ASP Global Marine Trading LLC. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
